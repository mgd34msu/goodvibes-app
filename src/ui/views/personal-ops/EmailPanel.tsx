...
//
// The INBOUND half (the watcher's status chip and the verification
// expectations it correlates arriving mail against) lives in
// InboundExpectations.tsx and is mounted below, so this file stays about the
// mailbox the user reads and writes.
...
import { ExpectationsPanel, InboundStatusChip } from "./InboundExpectations.tsx";
import {
  emailRefusal,
  formatEpoch,
  parseInboxMessages,
...
export function EmailPanel({
  ...
  return (
    <>
      <section className="po-panel" aria-label="Email inbox">
        <div className="po-toolbar">
          ...
          <div className="po-toolbar__actions">
            <InboundStatusChip active={active} />
      ...
      <ExpectationsPanel active={active} />
    </>
  );
}

...
/** Highlight `code`; unknown language auto-detects; falls back to escapeHtml. */
export function highlightCode(code: string, language: string): { language: string; html: string } {
